...
class Provider extends InheritedWidget {
  ...
  static Bloc of(BuildContext context) {
    ...
    this function should return Provider type but as we hover on this Provider we will see that the function returns InheritedWidget type provider.
    so to get the return type as provider we clarify dart by writing "as provider" so that it returns the provider type function.
