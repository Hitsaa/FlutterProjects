...
this error message is shown when we try to listen streams multiple times but we assign single subscription stream to our stream builder. (read Stream Builder documentation)
to listen streams multiple times we have to assign broadcast subscription stream to our stream builder.
by default we make a single-subscription stream but mostly we use broadcast stream.
 */
